# MetaBeasts ![License](https://img.shields.io/badge/license-MIT-blue) ![PRs Welcome](https://img.shields.io/badge/PRs-welcome-green.svg)
...
- 🙌 Get latest updates? Follow our [Twitter](https://twitter.com/MetaBeastsApp).
- 💕 Love this project? Consider [buy me a coffee](https://www.buymeacoffee.com/metabeasts).

MetaBeasts works on all PC browsers (mobile browsers are currently not supported)
...
```bash
git clone https://github.com/rishi-xyz/metabeasts.git
```

This will create a folder named `MetaBeasts`. You can specify a different folder name like this:

```bash
git clone https://github.com/rishi-xyz/metabeasts.git my-folder-name
```

To start a server, go into the project folder and install dependencies/run start command:

```bash
cd MetaBeasts or 'my-folder-name'
yarn && yarn start
```
...
```bash
cd MetaBeasts/client or 'my-folder-name/client'
yarn && yarn dev
```
...
If you're using MetaBeasts to power your virtual office or using our code in other projects, please consider [buy me a coffee](https://www.buymeacoffee.com/metabeasts). Thank you :)
